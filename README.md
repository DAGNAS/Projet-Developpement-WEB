...
## Objectifs :
- Centralisation et simplification des accès aux recherches de stages.
- Réalisation d'un outil moderne et efficace.
- Respecter le cahier des charges.
- rescpecter les demandes clients.
- 
...
## Effectif :
<u>Notre groupe projet se compose de quatre personnes :</u>- Kaëlig CLENET, chef de projet, développeur
